...
- **Git** - version control. Tracks every change and is how you share code on GitHub. Ships with macOS and most Linux distros; Windows needs a separate installer from [git-scm.com](https://git-scm.com/).
