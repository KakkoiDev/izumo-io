...
The Pareto Principle says that roughly 80% of results come from 20% of efforts. In programming, 20% of the features deliver 80% of the value. Learning to identify and focus on that critical 20% is the difference between productive developers and busy developers. {.lesson-intro}
