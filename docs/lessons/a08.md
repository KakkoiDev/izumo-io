...
- **An `AGENTS.md`** with your standing rules (A05). It should make the AI answer the way *you* want by default.
- **One skill** you genuinely use (A06). Not a demo, something that saves you real time.
...
1. Finalize your `AGENTS.md`, one skill, and one script. Make sure each works.
...
<h2>Key Takeaways</h2>
<ul>
<li>The deliverable is a personal toolkit: an AGENTS.md, a skill, and a script you understand</li>
...
<li>Keep building: grow your skills, learn more terminal, read the privacy terms</li>
</ul>
</div>
