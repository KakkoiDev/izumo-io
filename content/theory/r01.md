...
Information Technology is about four actions: collecting information, sending it somewhere, processing it into something useful, and storing it for later. Every app, website, and system you use is just doing some combination of these four things - from a calculator to a social network. {.lesson-intro}
