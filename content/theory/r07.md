...
Complexity is the enemy of reliability. Every line of code you write is a line that can break. The best code is code you did not have to write. Simple solutions are easier to understand, debug, test, and maintain. When in doubt, choose the simpler approach. {.lesson-intro}
