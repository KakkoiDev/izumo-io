...
1. In the folder where you run `agy`, make a skill folder: `mkdir -p .agents/skills/explain-simply` (use your own name).
2. Inside it, create `SKILL.md` for a skill that solves a real annoyance for you (a "summarize in three bullets" or "explain simply" skill like above). Write a clear description so the agent knows when to use it.
