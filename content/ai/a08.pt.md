...
- **Um `GEMINI.md`** com suas regras permanentes (A05). Deve fazer a IA responder do jeito que *você* quer por padrão.
- **Um comando personalizado** que você realmente usa (A06). Não uma demonstração, algo que te economiza tempo de verdade.
...
```mermaid
flowchart TD
    T[Seu kit de ferramentas de IA] --> M[GEMINI.md: suas regras]
    T --> C["Comando personalizado: /yours"]
...
- Aumente sua biblioteca de comandos conforme perceber prompts repetidos.
...
1. Finalize seu `GEMINI.md`, um comando personalizado e um script. Garanta que cada um funciona.
...
<h2>Pontos-chave</h2>
<ul>
<li>O resultado é um kit pessoal: um GEMINI.md, um comando personalizado e um script que você entende</li>
...
<li>Continue construindo: aumente seus comandos, aprenda mais terminal, leia os termos de privacidade</li>
</ul>
</div>
