...
```mermaid
flowchart LR
    A[Resposta da IA] --> B{Parece confiante?}
    B -->|Sempre| C[Confiante não é correto]
    C --> D[Verifique antes de confiar]
```
...
**Ainda travado?** Copie o endereço desta página do seu navegador e entregue para o seu assistente de IA, depois conte o que deu errado. Ele consegue ler a lição inteira e descobrir um conserto para o seu computador específico. Esse truque funciona em todas as lições deste curso, não só nesta.
