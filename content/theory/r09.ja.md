...
analogy: "未知の地図を探索する"
source_sha: "b0bc6059a4b1"
---
# R09: 学び方

スキルの学習には予測可能な段階があります。最初は知らないことを知らない(無意識の無能)。次に知らないことの多さに気づく(意識的な無能)。次に努力すればできる(意識的な有能)。最後に自動的にできる(無意識の有能)。自分がどこにいるか理解すれば、より効果的に学べます。
{: .lesson-intro }
