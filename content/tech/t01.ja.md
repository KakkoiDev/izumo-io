---
title: "環境セットアップ"
desc: "VS Code、Node.js、ブラウザをインストール。ターミナルで確認。hello.htmlを書いて動かす。"
---
# T01: 環境セットアップ

職人は最初の切削の前に作業台を整えます。Webを作るために、コンピュータには3つの道具が必要です。コードを書くエディタ、ブラウザ外でJavaScriptを実行するランタイム、結果を見るブラウザ。午後1回のセットアップが後の千の苛立ちを救います。一度やって永遠に忘れましょう。 {.lesson-intro}
