...
Antes de construir, vá jogar o jogo pronto: [online.kakkoi.dev](https://online.kakkoi.dev). Ande por aí e veja o que ele faz. É isso que você está prestes a criar, uma caixinha por vez. Curioso para ver como foi feito? O código está no GitHub: [KakkoiSchool/kakkoi-online](https://github.com/KakkoiSchool/kakkoi-online).
