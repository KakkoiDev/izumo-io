...
- **A `GEMINI.md`** with your standing rules (A05). It should make the AI answer the way *you* want by default.
- **One custom command** you genuinely use (A06). Not a demo, something that saves you real time.
