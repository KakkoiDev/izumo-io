...
- **A `GEMINI.md`** with your standing rules (A06). It should make the AI answer the way *you* want by default.
- **One custom command** you genuinely use (A07). Not a demo, something that saves you real time.
- **One script** the AI helped you write (A08), that does something useful and that you have read and understood. Run by hand is fine.
