...
| **Stopping cheats** | [A22](a22.html) stops one specific cheat — peeking at the other player's move. It does not stop someone editing their own position, or their own health | A referee that recalculates everything both players claim. That is most of what a game server actually does |
