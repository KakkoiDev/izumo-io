...
English is the lingua franca of the technology world. You do not need to speak it perfectly, but having a good working mastery of it is one of the highest-leverage skills you can develop as a developer. It is the language that most documentation, tutorials, forums, job postings, and open source projects use. {.lesson-intro}
