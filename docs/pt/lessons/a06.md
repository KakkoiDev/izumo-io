...
1. Na pasta onde você roda o `agy`, crie `.agents/skills/` se não existir.
2. Monte uma skill que resolva um incômodo real seu, por exemplo uma skill de "resumir em três tópicos" ou de "explicar de forma simples" como acima. Escreva uma description clara para o agente saber quando usar.
