...
![The demo showing two folded fingerprints as long strings of characters, and the verdict "Caught cheating! They showed rock, but the note they folded was not rock."](../static/img/game/a22.png)
...
3. Press a move again, then press **Try to cheat**. The screen says **"Caught cheating!"** We read the same result back and got `{ youHonest: true, theyHonest: false }`: the opponent had folded `paper` and showed `rock`.
