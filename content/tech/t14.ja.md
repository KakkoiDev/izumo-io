...
source_sha: "efdb4c67a9c4"
---
# T14: データの永続化

Webページは閉じると全てを忘れます。localStorageはブラウザがあなたのWebサイト用に保持するノートのようなものです。タブを閉じてもデータは残ります。JSONはJavaScriptオブジェクトを保存可能な文字列に変換し、元に戻すための共通形式です。
{: .lesson-intro }
