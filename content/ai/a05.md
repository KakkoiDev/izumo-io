...
1. In the folder where you run `agy`, create an `AGENTS.md` (`touch AGENTS.md`, or just open it in your editor) with three or four rules for how you want the AI to answer you (level, length, "always show an example," language).
