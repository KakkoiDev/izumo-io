...
Many developers can code, but fewer can ship. Finishing a project, polishing it, documenting it, and presenting it professionally is a separate skill from writing code. It is what separates hobby projects from portfolio pieces. {.lesson-intro}
