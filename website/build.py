...
TECH_PHASES = [
    {
        'id': 1,
        'title_en': 'Phase 1: The Workbench (Environment Setup)',
        'title_ja': 'フェーズ1: 作業台 (環境セットアップ)',
        'subtitle_en': 'Install the tools before the first cut',
        'subtitle_ja': '最初の切削の前に道具を揃える',
        'analogy_en': 'A craftsman prepares the workbench before starting the first piece',
        'analogy_ja': '職人は最初の作品を始める前に作業台を整える',
    },
    {
        'id': 2,
        'title_en': 'Phase 2: The Command Line (Terminal)',
        'title_ja': 'フェーズ2: コマンドライン (ターミナル)',
    ...
    {
        'id': 3,
        'title_en': 'Phase 3: The Book (HTML/CSS)',
        'title_ja': 'フェーズ3: 本 (HTML/CSS)',
    ...
    {
        'id': 4,
        'title_en': 'Phase 4: The Brain (JavaScript)',
        'title_ja': 'フェーズ4: 脳 (JavaScript)',
    ...
    {
        'id': 5,
        'title_en': 'Phase 5: The Time Machine (Git & GitHub)',
        'title_ja': 'フェーズ5: タイムマシン (GitとGitHub)',
    ...
    {
        'id': 6,
        'title_en': 'Phase 6: The Kitchen (Backend)',
        'title_ja': 'フェーズ6: 厨房 (バックエンド)',
    ...
    {
        'id': 7,
        'title_en': 'Phase 7: The Robot Chef (AI)',
        'title_ja': 'フェーズ7: ロボットシェフ (AI)',
    ...
    {
        'id': 8,
        'title_en': 'Phase 8: The Franchise Kit (Frontend Frameworks)',
        'title_ja': 'フェーズ8: フランチャイズキット (フロントエンドフレームワーク)',
    ...
    {
        'id': 9,
        'title_en': 'Phase 9: The Headquarters (Backend Frameworks)',
        'title_ja': 'フェーズ9: 本部 (バックエンドフレームワーク)',
    ...
    {
        'id': 10,
        'title_en': 'Phase 10: The Lego Kit (Web Components)',
        'title_ja': 'フェーズ10: レゴキット (Web Components)',
    ...
    {
        'id': 11,
        'title_en': 'Phase 11: The Blueprint (System Design)',
        'title_ja': 'フェーズ11: 設計図 (システム設計)',
...
TECH_LESSONS = [
    # Phase 1: Setup
    {'id': 'T39', 'phase': 1, 'status': 'available',
     'title_en': 'Environment Setup',
     'title_ja': '環境セットアップ',
     'desc_en': 'Install VS Code, Node.js, and a browser. Verify with the terminal. Write hello.html and see it run.',
     'desc_ja': 'VS Code、Node.js、ブラウザをインストール。ターミナルで確認。hello.htmlを書いて動かす。'},
    # Phase 2: Command Line
    {'id': 'T34', 'phase': 2, 'status': 'available',
    ...
    {'id': 'T35', 'phase': 2, 'status': 'available',
    ...
    # Phase 4: JavaScript
    {'id': 'T07', 'phase': 4, 'status': 'available',
    ...
    {'id': 'T08', 'phase': 4, 'status': 'available',
    ...
    {'id': 'T09', 'phase': 4, 'status': 'available',
    ...
    {'id': 'T10', 'phase': 4, 'status': 'available',
    ...
    {'id': 'T11', 'phase': 4, 'status': 'available',
    ...
    {'id': 'T14', 'phase': 4, 'status': 'available',
    ...
    {'id': 'T15', 'phase': 4, 'status': 'available',
    ...
    # Phase 6: Backend
    {'id': 'T16', 'phase': 6, 'status': 'available',
    ...
    # Phase 7: AI
    {'id': 'T21', 'phase': 7, 'status': 'available',
    ...
    {'id': 'T22', 'phase': 7, 'status': 'available',
    ...
    # Phase 8: Frontend Frameworks
    {'id': 'T23', 'phase': 8, 'status': 'available',
    ...
    {'id': 'T24', 'phase': 8, 'status': 'available',
    ...
    {'id': 'T27', 'phase': 8, 'status': 'available',
    ...
    # Phase 9: Backend Frameworks
    {'id': 'T28', 'phase': 9, 'status': 'available',
    ...
    {'id': 'T29', 'phase': 9, 'status': 'available',
    ...
    {'id': 'T32', 'phase': 10, 'status': 'available',
    ...
    {'id': 'T33', 'phase': 10, 'status': 'available',
    ...
    {'id': 'T36', 'phase': 11, 'status': 'available',
    ...
    {'id': 'T37', 'phase': 11, 'status': 'available',
    ...
    {'id': 'T38', 'phase': 11, 'status': 'available',
