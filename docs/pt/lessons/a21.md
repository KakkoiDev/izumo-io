...
![The demo with the "opponent remembers you" box ticked, showing "You lose. You played fire. The watcher played water. water beats fire." and a score of won 2, lost 17, drew 5](../static/img/game/a21.png)

Open the page with Live Server and:

1. Leave the box **unticked** and press **fire** twenty-four times. Wins, losses and draws all pile up in roughly equal thirds. When we did this we got 9 wins, 6 losses, 9 draws.
2. Tick the box, so the watcher is playing, and press **fire** twenty-four times again. It turns brutal. We got **2 wins and 17 losses** — the watcher noticed we only ever play fire, and mostly played water.
...
4. Open the browser console and type `watcher.seen`. You get your last five moves — the whole of its memory, and it is a list of five strings.

We also proved point 2 of the split in the console. We invented a new fighter that had never existed, `{ name: 'stone statue', chooseMove: () => 'earth' }`, and passed it straight into `playRound`. It played a full round and the screen said "You played earth. The dice played earth." `playRound` was never told what a stone statue is.
