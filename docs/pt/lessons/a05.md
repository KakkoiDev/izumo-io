...
1. Na pasta onde você roda o `agy`, crie um `AGENTS.md` com três ou quatro regras de como você quer que a IA te responda (nível, tamanho, "sempre dê um exemplo", idioma).
